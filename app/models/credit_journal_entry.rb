class CreditJournalEntry < ActiveRecord::Base
  ...
  symbolize :source_type, in: [:card_order_debit, :card_order_credit, :credit_order, :credit_order_bonus, :signup, :referral, :promo, :credit_plan_payment, :unknown], validate: true
