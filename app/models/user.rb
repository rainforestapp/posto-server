class User < ActiveRecord::Base
  ...
  has_many :card_orders, foreign_key: "order_sender_user_id", order: "created_at asc"
  has_many :authored_card_designs, foreign_key: "author_user_id", class_name: "CardDesign", order: "created_at asc"
